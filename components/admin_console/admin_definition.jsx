            ...
            schema: {
                ...
                settings: [
                    ...
                    },
                    {
                        ...
                        placeholder_default: 'E.g.: "grammm-media"',
                        isDisabled: it.any(
                            it.not(it.userHasWritePermissionOnResource('environment')),
            ...
            schema: {
                ...
                settings: [
                    ...
                    },
                    {
                        ...
                        help_text_default: 'New user accounts are restricted to the above specified email domain (e.g. "grammm.org") or list of comma-separated domains (e.g. "corp.grammm.com, grammm.org"). New teams can only be created by users from the above domain(s). This setting only affects email login for users.',
                        placeholder: t('admin.team.restrictExample'),
                        placeholder_default: 'E.g.: "corp.grammm.com, grammm.org"',
                        isHidden: it.licensed,
                        isDisabled: it.not(it.userHasWritePermissionOnResource('authentication')),
                    },
                    {
                        ...
                        help_text_default: 'New user accounts are restricted to the above specified email domain (e.g. "grammm.org") or list of comma-separated domains (e.g. "corp.grammm.com, grammm.org"). New teams can only be created by users from the above domain(s). This setting affects email login for users. For Guest users, please add domains under Signup > Guest Access.',
                        placeholder: t('admin.team.restrictExample'),
                        placeholder_default: 'E.g.: "corp.grammm.com, grammm.org"',
                        isHidden: it.not(it.licensed),
                        isDisabled: it.not(it.userHasWritePermissionOnResource('authentication')),
